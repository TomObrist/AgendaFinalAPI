...
public class AuthenticationController : ControllerBase
{
    ...
    public AuthenticationController(IConfiguration config, IUserRepository userRepository)//inteccion de dependencia 
    {
    ...
    public ActionResult<string> Autenticar(AuthenticationRequestBody authenticationRequestBody) //Enviamos como parámetro la clase que creamos arriba
    {
        ...
        AuthenticationRequestBody authenticationRequestBody1 = authenticationRequestBody;
        var user = _userRepository.ValidateUser(authenticationRequestBody1); //Lo primero que hacemos es llamar a una función que valide los parámetros que enviamos.
